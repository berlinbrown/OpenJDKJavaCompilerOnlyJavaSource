...
package berlin.javax.annotation.processing;
 ...
 * berlin.javax.annotation.processing.RoundEnvironment rounds}.  On each
 ...
 * controlled.  For example, for a {@link berlin.javax.tools.JavaCompiler
 * JavaCompiler} the list of candidate processors to run can be
 * {@linkplain berlin.javax.tools.JavaCompiler.CompilationTask#setProcessors
 * set directly} or controlled by a {@linkplain
 * berlin.javax.tools.StandardLocation#ANNOTATION_PROCESSOR_PATH search path}
...
public interface Processor {
     ...
     * berlin.javax.lang.model.SourceVersion#isIdentifier identifiers}:
     *
     * <blockquote>
     * <dl>
     ...
     * @see berlin.javax.annotation.processing.SupportedOptions
     */
     ...
     * @see berlin.javax.annotation.processing.SupportedAnnotationTypes
     ...
     * processor.
     * @see berlin.javax.annotation.processing.SupportedSourceVersion
