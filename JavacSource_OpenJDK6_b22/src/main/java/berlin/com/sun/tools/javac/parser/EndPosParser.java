...
import static berlin.com.sun.tools.javac.tree.JCTree.*;

/**
 * This class is similar to Parser except that it stores ending positions for
 * the tree nodes.
 * 
 * <p>
...
public class EndPosParser extends Parser {
    ...
    /**
     * A hashtable to store ending positions of source ranges indexed by the
     * tree nodes. Defined only if option flag genEndPos is set.
     */
