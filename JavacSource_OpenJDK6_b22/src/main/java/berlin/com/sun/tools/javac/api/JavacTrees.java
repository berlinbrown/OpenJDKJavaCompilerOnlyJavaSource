...
import berlin.com.sun.source.tree.Scope;
...
public class JavacTrees extends Trees {
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
                ...
                && type instanceof berlin.com.sun.tools.javac.code.Type) {
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (berlin.com.sun.tools.javac.code.Type)type, (Symbol)member);
        } else
            return false;
    }
