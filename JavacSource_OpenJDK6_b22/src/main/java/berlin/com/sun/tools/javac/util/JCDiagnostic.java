...
import static berlin.com.sun.tools.javac.util.JCDiagnostic.DiagnosticType.*;
...
public class JCDiagnostic implements Diagnostic<JavaFileObject> {
    ...
    private static final String messageBundleName = "berlin.com.sun.tools.javac.resources.compiler";
