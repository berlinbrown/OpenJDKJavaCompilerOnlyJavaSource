...
import berlin.com.sun.tools.javac.file.CacheFSInfo;
import berlin.com.sun.tools.javac.file.JavacFileManager;
import berlin.com.sun.tools.javac.jvm.Target;
import berlin.com.sun.tools.javac.main.JavacOption.Option;
import berlin.com.sun.tools.javac.main.RecognizedOptions.OptionHelper;
import berlin.com.sun.tools.javac.processing.AnnotationProcessingError;
import berlin.com.sun.tools.javac.util.ClientCodeException;
import berlin.com.sun.tools.javac.util.Context;
import berlin.com.sun.tools.javac.util.FatalError;
...
import berlin.com.sun.tools.javac.util.PropagatedException;
...
/**
 * This class provides a command-line interface to the GJC compiler.
 */
public class Main {
        ...
        try {
            ...
            try {
                ...
                if (files == null) {
                    ...
                    // or version info
                    if (options.get("-help") != null || options.get("-X") != null || options.get("-version") != null
            ...
            boolean batchMode = (options.get("nonBatchMode") == null && System.getProperty("nonBatchMode") == null);
            if (batchMode)
    ...
    private static final String javacBundleName = "berlin.com.sun.tools.javac.resources.javac";
