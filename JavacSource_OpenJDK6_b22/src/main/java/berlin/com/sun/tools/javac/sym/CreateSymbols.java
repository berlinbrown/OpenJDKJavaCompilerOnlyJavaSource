...
package berlin.com.sun.tools.javac.sym;
...
import berlin.com.sun.tools.javac.jvm.Pool;
...
import berlin.javax.annotation.processing.AbstractProcessor;
import berlin.javax.annotation.processing.RoundEnvironment;
import berlin.javax.annotation.processing.SupportedAnnotationTypes;
import berlin.javax.annotation.processing.SupportedOptions;
...
import berlin.javax.tools.Diagnostic;
import berlin.javax.tools.JavaCompiler;
import berlin.javax.tools.JavaFileObject;
import berlin.javax.tools.StandardJavaFileManager;
import berlin.javax.tools.StandardLocation;
import berlin.javax.tools.ToolProvider;
...
import static berlin.javax.tools.JavaFileObject.Kind.CLASS;
...
public class CreateSymbols extends AbstractProcessor {
    ...
    static Set<String> getLegacyPackages() {
        ResourceBundle legacyBundle
            = ResourceBundle.getBundle("berlin.com.sun.tools.javac.resources.legacy");
    ...
    void createSymbols() throws IOException {
        ...
        berlin.com.sun.tools.javac.main.JavaCompiler compiler =
            berlin.com.sun.tools.javac.main.JavaCompiler.instance(task.getContext());
    ...
    public static void main(String... args) {
        ...
        berlin.com.sun.tools.javac.MainJavac.compile(args);
    }
