...
import berlin.com.sun.tools.javac.main.JavacOption.OptionKind;
import berlin.com.sun.tools.javac.main.RecognizedOptions.GrumpyHelper;
...
public final class JavacTool implements JavaCompiler {
    ...
    /**
     * Constructor used by service provider mechanism. The correct way to obtain
     * an instance of this class is using create or the service provider
     * mechanism.
     * 
     * @see javax.tools.JavaCompilerTool
     * @see berlin.javax.tools.ToolProvider
     * @see #create
     */
    @Deprecated
    public JavacTool() {
    ...
    public JavacTask getTask(Writer out, JavaFileManager fileManager,
        ...
        while (flags.hasNext()) {
            ...
            if (option.hasArg()) {
                ...
                if (option.process(optionTable, flag, operand))
                    // should not happen as the GrumpyHelper will throw
                    // exceptions
                    // in case of errors
    ...
    public int run(InputStream in, OutputStream out, OutputStream err, String... arguments) {
        ...
        return berlin.com.sun.tools.javac.MainJavac.compile(arguments, new PrintWriter(err, true));
    }
